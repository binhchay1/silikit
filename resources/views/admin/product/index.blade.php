...
@section('title', 'Sản phẩm | SILI - KIT')
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:void(0)" data-id="{{ $item->id }}" data-name="{{ $item->name }}" class="btn btn-md btn-danger delete_product ml-2"><i class="fas fa-lock"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
